...
(
  ...
  'https://johnsmith.dev',
  '["React", "Node.js", "JavaScript", "Python", "AWS", "Docker", "PostgreSQL", "GraphQL", "TypeScript", "Kubernetes"]'::jsonb,
  '[
...
(
  ...
  null,
  'https://sarahjohnson.com',
  '["Product Marketing", "Analytics", "A/B Testing", "Salesforce", "HubSpot", "Content Marketing", "SEO", "Social Media Marketing"]'::jsonb,
  '[
    {"language": "English", "proficiency": "Native"},
...
(
  ...
  '["Figma", "Sketch", "Adobe XD", "Prototyping", "User Research", "Design Systems", "HTML", "CSS", "JavaScript"]'::jsonb,
  '3-5',
  75000,
  95000,
  'hybrid',
...
(
  ...
  '["Python", "R", "SQL", "Machine Learning", "TensorFlow", "Pandas", "Scikit-learn", "Tableau", "Power BI"]'::jsonb,
  '3-5',
  95000,
  125000,
  'remote',
